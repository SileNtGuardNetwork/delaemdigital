export const siteConfig = {
  ...
  hero: {
    ...
    subtitle:
      "Собираем управляемый маршрут: оффер, структура, копирайтинг, дизайн, форма, согласие, аналитика и подготовка к трафику. Для B2B и экспертов, которым нужен предсказуемый поток заявок.",
    ...
    proof: [
      ...
      "Форма с согласием и статусами",
      "Готовность к SEO и трафику",
    ],
    routeSteps: [
      { id: "traffic", label: "Трафик", hint: "SEO и реклама" },
      { id: "screen", label: "Экран", hint: "Оффер и CTA" },
      { id: "trust", label: "Доверие", hint: "FAQ и legal" },
      { id: "lead", label: "Заявка", hint: "Форма и согласие", active: true },
      { id: "handle", label: "Обработка", hint: "Уведомление владельцу" },
    ],
  },
  problem: {
